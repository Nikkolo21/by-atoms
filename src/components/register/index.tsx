...
export const Register = () => {
    ...
    return (
        <Wrapper display='grid' placeItems='center' height='100%'>
            <Wrapper borderRadius='10px' padding='120px 0' width='100%' maxWidth='800px' backgroundColor='#FFF8F3' display='grid' placeItems='center'>
                <Formik
                    ...
                    {({ values, isSubmitting, handleChange, handleBlur }) => (
                        <Form style={{width: '100%'}}>
                            <Wrapper height='80px' display='grid' placeItems='center'>
                                <Input onChange={handleChange} onBlur={handleBlur} value={values.email} name='email' type='email' width='70%' height='70%' placeholder='Email' />
                            </Wrapper>
                            <Wrapper height='80px' display='grid' placeItems='center'>
